...
{
    return function (t) {
        var n = new Date(t || new Date); return new Date(n.getTime() + ((e - n.getDay() + 7) % 7 + 1) * 864e5)
    }
}
(function (e)
{
    function r(e, t)
    {
        var n = new Date(e), n = new Date(n.setDate(n.getDate() + Number(t))), r = n.getDate(), i = n.getMonth() + 1, s = n.getFullYear();
    ...
    e.fn.weekLine = function (t)
    {
        ...
        init: function (n) {
            return this.each(function () {
                ...
                r.addClass("weekDays cleanslate").append(o).mouseup(
                    function () { s = false; return false });
                $days = r.children().bind("mousedown", function () {
                    if (r.settings.mousedownSel) { s = true } u(this);
                    return false
            ...
            this.children().each(function () {
                $day = e(this); if ($day.hasClass(t)) {
                    switch (n) {
                        case "indexes": u += $day.attr("href").substr(1) + ",";
                            break;
                        case "dates": u += r(i ? i : s.startDate ? s.startDate :
                            new Date, $day.attr("href").substr(1)) + ",";
                            break;
                        case "descriptive": if (o == null) {
                            u = $day.html()
                        } else {
            ...
            var r = e(this), s = r.children(),
                o = n.split(","); s.removeClass(t);
                for (i in o) {
